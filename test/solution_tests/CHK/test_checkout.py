...
class TestCheckout():
    ...
    def test_checkout(self):
        ...
        # assert checkout() ==
        # assert checkout() ==
        # assert checkout('ABE') == 120
        # assert checkout('ABEE') == 130
        # assert checkout('B'*2 + 'E'*7) == 280
        # assert checkout('A'*2 + 'B'*6 + 'E'*7) == 455
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4) == 885
        # assert checkout('A'*14 + 'B'*5 + 'C'*2 + 'D'*2) == 770
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*2) == 905
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*5) == 925
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*6) == 925
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*7) == 935
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*8) == 945
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*9) == 945
        # assert checkout('A'*14 + 'B'*7 + 'C'*4 + 'D'*4 + 'F'*10) == 955
        # assert checkout('H'*38) == 3*80 + 1*45 + 3*10
        # assert checkout('V' * 16) == 5*130 + 1*50
        # assert checkout('V' * 17) == 5 * 130 + 1 * 90
        # assert checkout('R' * 7 + 'Q'*9) == 7 * 50 + 2*80 + 30
